...
# --- Configuration ---
TOKEN = '8689794871:AAHLWS0ceuvd7Nc8-2m7K_vJzdLwVYWcMSw' # Replace with your actual token
...
def create_main_menu_inline(user_id):
    ...
    buttons = [
        ...
        types.InlineKeyboardButton('📞 Contact Owner', url=f'https://t.me/{YOUR_USERNAME.replace("@KiyotakaHere", "")}')
    ]
...
def _logic_contact_owner(message):
    markup = types.InlineKeyboardMarkup()
    markup.add(types.InlineKeyboardButton('📞 Contact Owner', url=f'https://t.me/{YOUR_USERNAME.replace("@KiyotakaHere", "")}'))
